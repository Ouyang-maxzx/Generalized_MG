...
numofRows = MG.horizon*MG.numofEV;
%EV SOC
A_EV = [];
...
b_min = reshape( repmat(-MG.EV.SOC_min+MG.EV.SOC_0, MG.horizon, 1), [], 1);
b_max = reshape( repmat( MG.EV.SOC_max-MG.EV.SOC_0, MG.horizon, 1), [], 1);
