function output = gen_type5_data (numofMG)
...
%% L0
L0_var = 0.1;
load('L0_type5'); % introduce 'PV_type1'
value = [];
if length(L0_type5) == 48
    L0_type5 = [L0_type5; 0]; % Add a zero at last to form the last hour
    for i = 1:1:size(L0_type5)-1
        value = [value,linspace(L0_type5(i,1), L0_type5(i+1,1), 30/timespan+1)];
        value = value(1:size(value,2)-1);
    end
else
